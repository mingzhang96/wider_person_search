...
"""
首先 每个 cast 都已经有自己的 最近的 candi 了
先 multi_face_recall 找到和每个 cast 的 每个 candi 最近的 candi，如果 sim > 0.5 就作为召回的一个 candi
然后 multi_search，对于每个 candi，找到 和每个 cast 的 所有 candi 最近的 相似度，作为这个 candi 和这个 cast 的相似度
"""
